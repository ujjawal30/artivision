...
const Searchbar = () => {
  ...
  return (
    <div className="flex items-center w-full rounded-2xl border-2 border-claret-200/20 bg-white px-4 shadow-sm shadow-claret-200/15 md:max-w-96">
      ...
      <Input
        className="border-0 bg-transparent text-gray-600 w-full placeholder:text-gray-400 h-12 font-medium focus-visible:ring-offset-0 p-3 focus-visible:ring-transparent"
        placeholder="Search"
